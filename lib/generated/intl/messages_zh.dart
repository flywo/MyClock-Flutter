...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m9(AppStoreUrl) => "Hello, 爱番茄(myclock)! 这是一款番茄时间管理规划的App，不再分心！不再拖延！高效！专注！学习必备的好工具哦！iOS下载：${AppStoreUrl}，Android 下载：Google Play Store";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "myclock" : MessageLookupByLibrary.simpleMessage("爱番茄"),
